...
public class ProjectReactor {
    ...
    //当前项目的 groupId、artifactId、package 等
    private static final String GROUP_ID = "com.zygh";
    private static final String ARTIFACT_ID = "project-template";
    private static final String PACKAGE_NAME = "com.zygh.project";
    private static final String TITLE = "系统";
    ...
    public static void main(String[] args) {
        ...
        log.info("[main][原项目地址 ({})]", projectBaseDir);

        // ========== 新项目的配置信息 ==========
        String groupIdNew = "com.company";
        String artifactIdNew = "test";
        String packageNameNew = "com.company.test";
        ...
        log.info("[main][需要重写的文件数量：{}]", files.size());
        // 写入文件
        files.forEach(file -> {
